...
export class SingleClientTrackingAndAnalytics extends Component {
constructor(props) {
  super(props)
...
client_id  : this.props.param.client_id.replace(/:/g,''),
...
<Typography sx={{fontSize:{xs:15,sm:17,marginTop:3,marginBottom:3},marginLeft:1,mb:1,fontWeight:'650',color:'#3e3e40'}}>CLIENT ID  - {this.props.param.client_id.replace(/:/g,'')}</Typography>
...
<Box sx={{width:'100%',height:45,display:'flex',justifyContent:'right'}}>
  <Box sx={{height:35,width:35,backgroundColor:'#fff0d3',borderRadius:1,display:'flex',justifyContent:'center',alignItems:'center'}}>

<InsightsIcon sx={{height:30,width:30,color:'#ffb621'}}/>
...
<Box sx={{width:'100%',height:45,display:'flex',justifyContent:'right'}}>
  <Box sx={{height:35,width:35,backgroundColor:'#cfe0f5',borderRadius:1,display:'flex',justifyContent:'center',alignItems:'center'}}>
<LanguageOutlinedIcon sx={{height:30,width:30,color:'#00a3ff'}}/>
  </Box>
</Box>
</Box>
</Paper>
...
<Box sx={{width:'100%',height:45,display:'flex',justifyContent:'right'}}>
  <Box sx={{height:35,width:35,backgroundColor:'#e4f5ef',borderRadius:1,display:'flex',justifyContent:'center',alignItems:'center'}}>
<LeaderboardIcon sx={{height:30,width:30,color:'#3deaaf'}}/>
  </Box>
</Box>
</Box>
</Paper>
...
<PaidIcon sx={{height:30,width:30,color:'#fe3879'}}/>
  </Box>
</Box>
</Box>
</Paper>
...
<Grid container sx={{mt:0.2}} spacing={1}><Grid item xs={12} sm={6}>
<Box>
...
export function SingleClientTrackingAndAnalyticsc(props){
    const navigate = useNavigate();
    const location = useLocation();
    const param = useParams()
    return (<SingleClientTrackingAndAnalytics  param={param} location={location} navigate={navigate}></SingleClientTrackingAndAnalytics>)
  }
