...
export class ClientContactProfile extends Component {
  constructor(props) {
    super(props)
...
var deparmentOnject = await localStorage.getItem('clientcontactData');
...
<Button disabled={this.state.permissiondata?this.state.permissiondata.department.is_edit?false:true:true} disableElevation size='small' onClick={this.edit} sx={{backgroundColor:'#00a3ff',width:100}} variant='contained'>Save</Button>
...
<br/>
<Button disabled={this.state.permissiondata?this.state.permissiondata.department.is_edit?false:true:true} disableElevation onClick={this.edit} size='small' sx={{backgroundColor:'#00a3ff',width:100}} variant='contained'>Save</Button>
...
export default ClientContactProfile
